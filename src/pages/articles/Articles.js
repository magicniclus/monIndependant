        ...
        <div className='articles'>
            ...
            <div className="content">
                <div className="articleOne article">
                    <ArticleCard img={article} title="Prix Moyen sur Bordeaux et Arcachon" text="Notre avis sur les  prix au m2 des différents quartiers de Bordeaux, sa métropole et sur le bassin d’arcachon.  Notre comparatif différencie les différents type de logement (appartement, maison, immeuble)." link="/articles/comparatif"/>
                </div>
            </div>
